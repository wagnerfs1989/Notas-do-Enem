...
clf = GridSearchCV(ols, param_grid=ols_params, verbose=100, refit='neg_mean_squared_error', return_train_score=False,cv=kf)
clf.fit(X_p, Y_Target)

#
## Ajustar e sintonizar o modelo
#clf = GridSearchCV(pipeline, hyperparameters, cv=kf,n_jobs =-1)
#clf.fit(X_p, Y_Target)
